...
describe("useConfidentialBalances", () => {
    ...
    const contractAddress2 = "0xabcdef1234567890abcdef1234567890abcdef12";
    beforeEach(() => {
        vi.clearAllMocks();
    });
    ...
    describe("account handling", () => {
        it("should accept shared account option", () => {
            const customAccount = "0x9876543210987654321098765432109876543210";
            const { result } = renderHook(() => useConfidentialBalances({
                contracts: [{ contractAddress: contractAddress1 }],
...
//# sourceMappingURL=useConfidentialBalances.test.js.map