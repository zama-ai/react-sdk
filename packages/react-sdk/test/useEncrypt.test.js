...
import { createTestWrapper, createMockFhevmInstance, ConnectedWrapper, DisconnectedWrapper, InitializingWrapper, TEST_ADDRESS, } from "./utils";
describe("useEncrypt", () => {
    ...
    describe("encrypt function", () => {
        it("should return undefined when not ready", async () => {
            ...
            const encrypted = await result.current.encrypt([{ type: "uint64", value: 100n }], contractAddress);
        ...
        it("should encrypt boolean values", async () => {
            ...
            const encrypted = await result.current.encrypt([{ type: "bool", value: true }], contractAddress);
    ...
    describe("error handling", () => {
        it("should propagate encryption errors", async () => {
            ...
            await expect(result.current.encrypt([{ type: "uint64", value: 100n }], contractAddress)).rejects.toThrow("Encryption failed");
        });
    });
...
//# sourceMappingURL=useEncrypt.test.js.map