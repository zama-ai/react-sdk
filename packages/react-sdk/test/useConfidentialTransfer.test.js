...
describe("useConfidentialTransfer", () => {
    ...
    describe("options handling", () => {
        ...
        it("should accept custom ABI", () => {
            ...
            const { result } = renderHook(() => useConfidentialTransfer({ contractAddress, abi: customAbi }), { wrapper: ConnectedWrapper });
            expect(result.current.status).toBe("idle");
        });
...
//# sourceMappingURL=useConfidentialTransfer.test.js.map