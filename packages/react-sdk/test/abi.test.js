...
import { encodeFunctionCall, decodeFunctionResult, SELECTORS, ZERO_HASH, UNWRAP_REQUESTED_TOPIC, } from "../src/internal/abi";
describe("abi", () => {
    describe("SELECTORS", () => {
    ...
    describe("decodeFunctionResult", () => {
        it("should decode address", () => {
            const data = ("0x" + "00".repeat(12) + "abcdefabcdefabcdefabcdefabcdefabcdefabcd");
