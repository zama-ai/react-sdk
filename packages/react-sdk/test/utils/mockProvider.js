 ...
 */
export function createMockEip1193Provider(overrides = {}) {
 ...
 */
export function createFailingProvider(failingMethods, error = new Error("Mock provider error")) {
 ...
 */
export function createDelayedProvider(delayMs) {
    const baseProvider = createMockEip1193Provider();
    return {
        request: vi.fn().mockImplementation(async (args) => {
